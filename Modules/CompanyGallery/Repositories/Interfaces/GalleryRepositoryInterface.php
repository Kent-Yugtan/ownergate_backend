...
{
    public function getAllGalleriesByCompanyId( int $perPage = 15):  LengthAwarePaginator;
    ...
    public function searchGalleries(string $keyword = null, ?string $startDate = null, ?string $endDate = null, ?string $type = null, int $perPage = 15): LengthAwarePaginator;
